          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Icon(Icons.terminal, color: Color(0xFF7C83FD), size: 32),
              ),
              ...
              // Feature bullets
              ...[
                ('SSH Terminal', 'Multi-tab, persistent connections with auto-reconnect', Icons.terminal),
                ('Docker', 'Manage containers, view logs and stats', Icons.widgets_outlined),
                ('Files', 'Browse, upload and edit files on your server', Icons.folder_outlined),
                ('Monitoring', 'CPU, RAM, disk and process monitoring', Icons.monitor_heart_outlined),
